...
// PDF generator — direct download, no preview window
function downloadPDF(result, user, mockNum) {
  const num = mockNum || 1;
  const html = `<!DOCTYPE html><html><head><title>ranklify.mocktest${num}</title>
<style>body{font-family:Arial,sans-serif;padding:32px;color:#222;max-width:800px;margin:0 auto}
h1{color:#4f8ef7;font-size:20px}
...
.stat-n{font-size:22px;font-weight:800;color:#4f8ef7}.stat-l{font-size:11px;color:#666;margin-top:4px}
...
<h1>${result.testType==="practice"?"Practice Test":"DDCET Mock Test"} — #${num}</h1>
<table style="width:auto;margin-bottom:16px;font-size:13px">
  ...
  <tr><td><b>Exam Type</b></td><td style="padding-left:24px">Personal Mock Test</td></tr>
...
<footer>Generated by Ranklify · File: ranklify.mocktest${num}.pdf</footer>
</body></html>`;
  const blob = new Blob([html],{type:"text/html"});
  const url  = URL.createObjectURL(blob);
  const a    = document.createElement("a");
  a.href=url; a.download=`ranklify.mocktest${num}.pdf`; a.click();
  ...
  if (phase==="result" && result) return (
    <div>
      ...
      <div style={{ display:"flex", gap:10, marginBottom:24, flexWrap:"wrap" }}>
        <button style={btn("primary")} onClick={()=>downloadPDF(result,user,result.mockNum||1)}>⬇ ranklify.mocktest{result.mockNum||1}.pdf</button>
